-- trg_notification_preferences_after_update_timestamp trigger’ı,
-- notification_preferences tablosunda bir kayıt güncellendiğinde
-- updated_at alanının otomatik olarak güncellenmesini sağlar

CREATE TRIGGER trg_notification_preferences_after_update_timestamp
